...
var normalizeNumber = function (msisdn, countryId) { return __awaiter(void 0, void 0, void 0, function () {
    var resource, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                resource = "/v1/phonenumbers/normalize?number=".concat(encodeURIComponent(msisdn));
                if (countryId) {
                    resource += "&countryId=".concat(countryId);
                }
                return [4 /*yield*/, client_1.noAuth.get(resource)];
            case 1:
                response = _a.sent();
